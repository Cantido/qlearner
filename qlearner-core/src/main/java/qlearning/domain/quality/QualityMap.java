...
public interface QualityMap {
     ...
     * @param action the {@code Action} taken from that {@code State}.
     * @return the {@code Quality} of that combination, or the specified
     * default value if the given {@code State}-{@code Action} combination
     ...
     * @return the highest {@code Quality} for any {@code Action} that can be
     * taken from the specified {@code State}.
     */
    Quality getBestQuality(State state);
    
    /**
     * Get the {@code Quality} vlaue that will be returned for any
    ...
    /**
     * Build a {@code StateActionQuality} triplet for the specified
     * {@code State}, {@code Action}, and that combination's {@code Quality}
