...
public class AgentBuilder {
	...
	/**
	 * Start building an {@link Agent} that will interact with the given
	 * {@link Environment}. You can immediately call {@link #getAgent()} to
	 * get an {@code Agent} populated with default values.
	 * 
	 * @param environment the environment that the result agent will
	 * interact with.
	 */
	...
	/**
	 * Get the resulting {@link Agent} that this object is building.
	 * Subsequent calls will return new and distinct agent objects.
	 * 
	...
	/**
	 * Get the {@code Executor} that this builder will give to its
	 * resulting {@link Agent}. This object could be a default value, or one
	...
	/**
	 * Get the {@code DiscountFactor} that this builder will give to its
	 * resulting {@link Agent}. This object could be a default value, or one
	 * provided by the user.
	 * 
	 * @return the {@code DiscountFactor} that the resulting {@code Agent}
	 * will use.
	 */
	...
	/**
	 * Get the {@code Environment} that this builder will give to its
	 * resulting {@link Agent}. This object was provided by the user on
	 * construction.
	 * 
	 * @return the {@code Environment} that the resulting {@code Agent}
	 * will use.
	 */
	...
	/**
	 * Get the {@code ExplorationStrategy} that this builder will give to its
	 * resulting {@link Agent}. This object could be a default value, or one
	 * provided by the user.
	 * 
	 * @return the {@code ExplorationStrategy} that the resulting {@code Agent}
	 * will use.
	 */
	...
	/**
	 * Get the {@code LearningRate} that this builder will give to its
	 * resulting {@link Agent}. This object could be a default value, or one
	 * provided by the user.
	 * 
	 * @return the {@code LearningRate} that the resulting {@code Agent}
	 * will use.
	 */
	...
	/**
	 * Get the {@code QualityMap} that this builder will give to its
	 * resulting {@link Agent}. This object could be a default value, or one
	 * provided by the user.
	 * 
	 * @return the {@code QualityMap} that the resulting {@code Agent}
	 * will use.
	 */
	...
	/**
	 * Get the {@code QualityUpdateStrategy} that this builder will give to its
	 * resulting {@link Agent}. This object could be a default value, or one
	 * provided by the user.
	 * 
	 * @return the {@code QualityUpdateStrategy} that the resulting
	 * {@code Agent} will use.
	 */
	...
	/**
	 * Set the {@code DiscountFactor} that this builder will give to its
	 * resulting {@link Agent} to control how it learns.
	 * 
	 * @param discountFactor the {@code DiscountFactor} that the resulting
	 * {@code Agent} will use.
	...
	/**
	 * Set the {@code Executor} that this builder will give to its
	 * resulting {@link Agent} to execute chosen {@link Action}s.
	 * 
	 * @param executor the {@code Executor} that the resulting
	 * {@code Agent} will use.
	 * @return this builder, for chaining
	 */
	...
	/**
	 * Set the {@code ExplorationStrategy} that this builder will give to its
	 * resulting {@link Agent} to control how it explores its
	 * {@link Environment}.
	 * 
	 * @param explorationStrategy the {@code ExplorationStrategy} that the
	 * resulting {@code Agent} will use.
	 * @return this builder, for chaining
	 */
	...
	/**
	 * Set the {@code LearningRate} that this builder will give to its
	 * resulting {@link Agent} to control how it learns.
	 * 
	 * @param learningRate the {@code LearningRate} that the
	 * resulting {@code Agent} will use.
	 * @return this builder, for chaining
	 */
	...
	/**
	 * Set the {@code QualityMap} that this builder will give to its
	 * resulting {@link Agent} to store {@link Quality} values.
	 * 
	 * @param qualityMap the {@code QualityMap} that the
	 * resulting {@code Agent} will use.
	 * @return this builder, for chaining
	 */
	...
	/**
	 * Set the {@code QualityUpdateStrategy} that this builder will give to its
	 * resulting {@link Agent} to update {@link Quality} values as it learns.
	 * 
	 * @param qualityUpdateStrategy the {@code QualityUpdateStrategy} that the
	 * resulting {@code Agent} will use.
	 * @return this builder, for chaining
	 */
