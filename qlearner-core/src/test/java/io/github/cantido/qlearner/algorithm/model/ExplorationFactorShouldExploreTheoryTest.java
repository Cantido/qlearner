...
public class ExplorationFactorShouldExploreTheoryTest {
  ...
  public static double[] invalidCheckValues = new double[] {DOUBLE_ONE};


  @DataPoints("checkValues")
  public static double[] checkValues = new double[] {DOUBLE_ZERO, 0.5};

  @DataPoints("factorValues")
  public static double[] factorValues = new double[] {DOUBLE_ZERO, 0.5, DOUBLE_ONE};

  @Theory
  public void zeroFactorNeverExplores(
                                      @FromDataPoints("checkValues") double checkValue,
  ...
  @Theory
  public void oneFactorAlwaysExplores(
                                      @FromDataPoints("checkValues") double checkValue,
                                      @FromDataPoints("factorValues") double factorValue) {
  ...
  @Theory
  public void generatedLessThanExplores(
                                        @FromDataPoints("checkValues") double checkValue,
                                        @FromDataPoints("factorValues") double factorValue) {
  ...
  @Theory
  public void generatedGreaterThanEqualToDoesNotExplore(
                                                        @FromDataPoints("checkValues")
                                                        double checkValue,
                                                        @FromDataPoints("factorValues")
                                                        double factorValue) {
  ...
  @Theory
  public void generatedEqualToDoesNotExplore(
                                             @FromDataPoints("checkValues") double checkValue,
                                             @FromDataPoints("factorValues") double factorValue) {
  ...
  @Theory
  public void checkValueOfOneIsInvalid(
                                       @FromDataPoints("invalidCheckValues") double checkValue,
                                       @FromDataPoints("factorValues") double factorValue) {
